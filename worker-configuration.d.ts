/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93f9a8dc1a9cad72dfedc6cd0b420e93)
// Runtime types generated with workerd@1.20250604.0 2025-06-04 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ZIG_VERSION: string;
		MCP_OBJECT: DurableObjectNamespace<import("./mcp").ZigDocsMcp>;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ZIG_VERSION">> {}
}
declare module "*.wasm" {
